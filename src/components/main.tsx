...
export default function MainContent() {
    return (
        <div className='w-full h-full justify-center flex flex-col mt-15 gap-4'>
            {/* role */}
            ...
            <section className='flex flex-col'>
                <h1 className='text-[40px] tracking-tighter font-bold mt-2 mb-3 leading-10 md:text-[84px] md:leading-none md:w-212.5'>
                    Construo produtos digitais <span className='text-accent'>claros, rápidos</span> e feitos para crescer.
                </h1>
                <p className='text-muted text-[14px] md:text-[16px] md:w-175 my-5'>
                ...
                <div className='flex w-full items-center mt-3 justify-between md:justify-normal'>
                    <button className='bg-accent text-background flex gap-2 px-2 md:px-4 py-4 text-sm font-semibold hover:bg-accent/80 transition-colors'>
                        Vamos conversar <span >↗</span>
                    </button>
                    <a href="#" className='text-muted text-xs px-12 py-3 flex gap-x-3 items-center hover:text-accent/80 transition-colors'>
