...
export default function Contact() {
    return (
        <div>
            ...
            <a href="mailto:leonardo.nasmt@gmail.com" className='w-fit hover:cursor-pointer bg-accent text-background flex gap-2 px-5 py-4 text-sm font-semibold hover:bg-accent/80 transition-colors'>
